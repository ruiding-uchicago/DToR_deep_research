#!/usr/bin/env python3
"""
Final synthesis for DToR research - combines all branch reports
"""
...
from ollama_deep_researcher.dtor_nodes import synthesize_final_report
...
def create_mock_state(branch_reports, topic, config_dict):
    """Create a DToRState object with branch summaries for final synthesis"""
    ...
    # Create state with all DToR parameters
    state = DToRState(
...
def main():
    parser = argparse.ArgumentParser(description='Generate final DToR synthesis')
    ...
    try:
        ...
        with open(output_file, 'w') as f:
            f.write(f"# Final DToR Synthesis Report\n\n")
